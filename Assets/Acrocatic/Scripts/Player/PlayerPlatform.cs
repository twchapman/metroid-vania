...
public enum PlatformTypes { None, Normal, Moving, Sinking };
...
public class PlayerPlatform : MonoBehaviour {
	...
	[HideInInspector]
	public PlatformTypes platformType;			// Get the current platform's type.
	[HideInInspector]
	...
	// Sinking platform variables for the player.
	[System.Serializable]
	public class SinkingPlatform {
	...
	[Tooltip("All variables related to sinking platforms are located here.")]
	public SinkingPlatform sinkingPlatform;
	...
	void Update () {
		...
		if (platformCollider && !currentPlatform) {
	...
	public bool OnPlatform() {
		return currentPlatform && platformType != PlatformTypes.None;
	}

	// Return if the player is on a moving platform.
	public bool OnMovingPlatform() {
		return OnPlatform() && platformType == PlatformTypes.Moving;
	}
